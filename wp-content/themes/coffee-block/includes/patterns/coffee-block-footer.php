...
<p class="has-text-color" style="color:#d1d1d1;line-height:1.8">Copyright © Coffee Block 2025. All Rights Reserved.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"align":"right","style":{"color":{"text":"#d1d1d1"},"typography":{"lineHeight":1.8}}} -->
<p class="has-text-align-right has-text-color" style="color:#d1d1d1;line-height:1.8">Design by: <a class="credlink" href="https://www.sktthemes.org/" target="_blank">SKT Themes</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>

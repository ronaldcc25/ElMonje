 ...
 */
class Cafeteria_Elementor_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'cafeteria-elementor' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'cafeteria-elementor-customize-controls' );
		wp_enqueue_script( 'cafeteria-elementor-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Cafeteria_Elementor_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public

jQuery(document).ready(function($) {
    'use strict';
    var this_obj = cafeteria_elementor_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.cafeteria-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message cafeteria-elementor-plugin-install');
                button.addClass('button-primary cafeteria-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.cafeteria-elementor-recommended-plugins .cafeteria-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.cafeteria-elementor-plugin-activate', function(event) {

...
// Changelog
if ( ! defined( 'CAFETERIA_ELEMENTOR_CHANGELOG_URL' ) ) {
    define( 'CAFETERIA_ELEMENTOR_CHANGELOG_URL', get_template_directory() . '/readme.txt' );
}

function cafeteria_elementor_changelog_screen() {
	global $wp_filesystem;
	$changelog_file = apply_filters( 'cafeteria_elementor_changelog_file', CAFETERIA_ELEMENTOR_CHANGELOG_URL );
            ...
            <div class="welcome-text-main">
                <div>
                    <div class="welcome-heding">
                        <h1 class="welcome-text-title"><?php echo esc_html__('Welcome to','cafeteria-elementor'); ?> <strong><?php echo esc_html__('Cafeteria Elementor Theme','cafeteria-elementor'); ?> </strong></h1>
                    </div>
                    <div class="welcome-text-subtitle">
                        <span class="welcome-text-desc-meta"><?php echo esc_html__('MizanThemes','cafeteria-elementor'); ?></span>
                    </div>
                </div>
                <div class="upgrade-button">
                    <a class="button button-primary" href="<?php echo esc_url( CAFETERIA_ELEMENTOR_BUY_NOW ); ?>"  target="_blank">
                        <?php esc_html_e( 'Buy Now', 'cafeteria-elementor' ); ?>
                    </a>
                    <a class="button button-primary" href="<?php echo esc_url( CAFETERIA_ELEMENTOR_LIVE_DEMO ); ?>"  target="_blank">
                        <?php esc_html_e( 'Live Demo', 'cafeteria-elementor' ); ?>
                    </a>
                    <a class="button button-primary" href="<?php echo esc_url( CAFETERIA_ELEMENTOR_PRO_DOC ); ?>"  target="_blank">
                        <?php esc_html_e( 'Pro Doc', 'cafeteria-elementor' ); ?>
                    </a>
                </div>
            </div>
			<ul class="inline-list">
                <li class="current">
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Setup With Elementor', 'cafeteria-elementor' ); ?>
                    </a>
                </li>
                <li class="get-start">
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'cafeteria-elementor' ); ?>
                    </a>
                </li>
                ...
                <li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Changelog', 'cafeteria-elementor' ); ?>
                    </a>
                </li>
				...
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'cafeteria-elementor' ); ?>
                    </a>
                </li>
			</ul>

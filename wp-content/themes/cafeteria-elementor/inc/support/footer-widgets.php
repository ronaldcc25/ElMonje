 ...
 * @since 1.0.0
 */
class Cafeteria_Elementor_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'cafeteria_elementor';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'cafeteria-elementor' ), $i ),
...
// Initialize.
$Cafeteria_Elementor_Footer_Widgets = new Cafeteria_Elementor_Footer_Widgets();
...
jQuery(document).ready(function(){
    ...
    jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-menu').attr("checked","checked");

    jQuery('#coffee-tea-setup-menu').click(function(){
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-menu').css("display","block");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-contact').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-widget').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-social-icon').css("display","none");
    });

    jQuery('#coffee-tea-setup-contact').click(function(){
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-menu').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-contact').css("display","block");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-widget').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-social-icon').css("display","none");
    });

    jQuery('#coffee-tea-setup-widget').click(function(){
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-menu').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-contact').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-widget').css("display","block");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-social-icon').css("display","none");
    });

    jQuery('#coffee-tea-setup-social').click(function(){
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-menu').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-contact').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-widget').css("display","none");
        jQuery('#coffee-tea-demo-setup-guid .coffee-tea-setup-social-icon').css("display","block");
    });
});